    ...
    <div className="admin-sidebar">
      <div className="sidebar-content">
        <div className="section">
          ...
          {studentOpen && (
            <div className="sub-buttons">
              <a href="/moderator/student/management">
                <button className="sidebar-btn submenu-btn">
                  <span>Manage Students</span>
                </button>
              </a>
              <a href="/moderator/student/pre-thesis">
                <button className="sidebar-btn submenu-btn">
                  <span>Manage Pre-Theses</span>
                </button>
              </a>
              <a href="/moderator/student/thesis">
                <button className="sidebar-btn submenu-btn">
          ...
          <div>
            ...
            {teacherOpen && (
              <div className="sub-buttons">
                ...
                <a href="/moderator/teacher/semester-assignment">
                  <button className="sidebar-btn submenu-btn">
        ...
        <div className="section">
          ...
          <a href="/moderator/announcements/">
          ...
          <a href="/moderator/configurations/">
            <button className="sidebar-btn">
